...
//			+ "_RVM";
			...
			for(File outputFile : testCaseProg.outputFiles){
				...
				String[] cmdarray;
				if (os.toLowerCase().contains("windows")) {
					String[] cmdarray2 = { "java", "-Xmx10M", "-cp", ".;" + classpath + ";" + ajcrtlibPath + ";" + monitoredDirPath + ";" + rvmonitorrtLibPath,
							name };
					cmdarray = cmdarray2;
				} else {
					String[] cmdarray2 = { "java", "-Xmx10M", "-cp", ".:" + classpath + ":" + monitoredDirPath + ":" + rvmonitorrtLibPath + ":" + ajcrtlibPath,
							name };
					cmdarray = cmdarray2;
