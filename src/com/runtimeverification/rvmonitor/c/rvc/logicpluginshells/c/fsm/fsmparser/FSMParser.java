...
package com.runtimeverification.rvmonitor.c.rvc.logicpluginshells.c.fsm.fsmparser;
...
//| ["@interests:" <Id> {"," <Id>}]
  ...
  final public FSMItem FSMItem() throws ParseException {
        String state;
        List<FSMTransition > Transitions = new ArrayList<FSMTransition >();     int line;
        int column;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x40000000,0x2000,0x81000,0x40000000,0x84000,0x40084000,0x40000000,0x84000,0x81000,};
   }
