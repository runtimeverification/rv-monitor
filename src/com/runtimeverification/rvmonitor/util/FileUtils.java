...
public class FileUtils {
    ...
    /**
     * Extract a literal file from a jar. Only files in /jar_include/ are copied over verbatim to
     * the jar file, so /jar_include/ is included as part of the path.
     * @param classSource A class in the relevant package of the jar.
     * @param path The path of the file, relative to /jar_includes/ in the package of 
     *     {@link classSource}.
     */
     ...
     * Extract a literal file from a jar. Only files in /jar_include/ are copied over verbatim to
     * the jar file, so /jar_include/ is included as part of the path.
     * @param classSource An instance of a class in the relevant package of the jar.
     * @param path The path of the file, relative to /jar_includes/ in the package of 
     *     {@link classSource}.
     */
