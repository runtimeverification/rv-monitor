...
public class Main {
	...
	public static void print_help() {
		System.out.println("Usage: java [-cp javmaop_classpath] com.runtimeverification.rvmonitor.java.rvj.TestSuite [-options] <test suite dir>");
		System.out.println("");
	...
	static public boolean process(String testSuiteDirPath) {
		...
		try {
			...
			title3 = "*** into runtime monitors (using com.runtimeverification.rvmonitor.java.rvj) ***";
...
//			System.out.println();
	...
	public static void main(String[] args) {
		...
		if (!Main.isJarFile && !new File(Main.rvmonitorDir).exists()) {
			System.err.println("[ERROR] the given com.runtimeverification.rvmonitor.java.rvj directory does not exist.");
			return;
		}
		try {
