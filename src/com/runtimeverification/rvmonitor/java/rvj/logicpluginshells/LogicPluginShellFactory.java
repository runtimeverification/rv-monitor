package com.runtimeverification.rvmonitor.java.rvj.logicpluginshells;
...
public class LogicPluginShellFactory {
				...
				if ((jarEntry.getName().startsWith(packageName)) && (jarEntry.getName().endsWith(".class"))) {
					...
					if (!clazz.isInterface()) {
						...
						while (superClass != null) {
							if (superClass.getName() == "com.runtimeverification.rvmonitor.java.rvj.logicpluginshells.LogicPluginShell") {
								classes.add(clazz);
								break;
							}
	...
	static public LogicPluginShellResult process(LogicRepositoryType logicOutput, String events) throws RVMException {
		LogicPluginShell logicShellPlugin = findLogicShellPlugin("com.runtimeverification.rvmonitor.java.rvj.logicpluginshells", logicOutput.getProperty().getLogic());
