...
/**
 * This class is the super class of any member of a class, such as
...
public abstract class CodeMember {
	...
	protected CodeMember(String name, boolean publik, boolean statik, boolean finale, CodeType type) {
		this.name = name;
		this.publik = publik;
		this.statik = statik;
		this.finale = finale;
