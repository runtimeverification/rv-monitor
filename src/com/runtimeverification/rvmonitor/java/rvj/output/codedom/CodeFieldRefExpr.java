...
/**
 * This class represents a field reference expression.
 * The reference can be used for both getfield and setfield.
 * If the referred field is static, the 'target' field is null.
 *
...
public class CodeFieldRefExpr extends CodeExpr {
	...
	private CodeFieldRefExpr(CodeType declaring, CodeExpr target, CodeMemberField field) {
		super(field.getType());
