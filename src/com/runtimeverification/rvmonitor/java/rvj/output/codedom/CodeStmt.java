...
public abstract class CodeStmt extends CodeObject {
	/**
	 * Tells the code generator whether this statement generates a block,
	 * or a single statement. The returned value is used to put a semicolon.
	 ...
	 * approach.
	 * @see CodeLegacyStmt
	 * @param rawstmt the code generated by the old approach
...
/**
 * This class represents code generated by the old string-based
 * method and should be considered a statement.
 * Although I replaced the old approach by the new CodeDOM
 * way in many places, the old way is still used. This class encapsulates
 * the string generated by the old method.
 *
 * @author Choonghwan Lee <clee83@illinois.edu>
 */
