/* Generated By:JavaCC: Do not edit this line. RVMonitorParser.java */
 ...
 */
public final class RVMonitorParser implements RVMonitorParserConstants {

    private static RVMonitorParser parser;

    public static RVMSpecFileExt parse(InputStream in, String encoding) throws ParseException {
        if (parser == null) {
            parser = new RVMonitorParser(in, encoding);
        } else {
            parser.ReInit(in);
        }
        return parser.RVMSpecFile();
    }

    public static RVMSpecFileExt parse(InputStream in) throws ParseException {
        return parse(in, null);
    }

    public static RVMSpecFileExt parse(File file, String encoding) throws ParseException {
        try {
    ...
    public static RVMSpecFileExt parse(File file) throws ParseException {
...
/*************************************************
 * THE JAVARVM SPECIFICATION GRAMMAR STARTS HERE *
 *************************************************/
  final public RVMSpecFileExt RVMSpecFile() throws ParseException {
        ...
        List<RVMonitorSpecExt> specList = new ArrayList<RVMonitorSpecExt>();
        RVMonitorSpecExt spec = null;
        int line = -1;
        int column = -1;
    ...
    label_2:
    while (true) {
      spec = RVMonitorSpec(packageName);
    ...
    default:
      ...
      throw new ParseException();
         ...
         {if (true) return new RVMSpecFileExt(line, column, packageName, imports, specList);}
    throw new Error("Missing return statement in function");
  }

  final public RVMonitorSpecExt RVMonitorSpec(PackageDeclaration packageName) throws ParseException {
        int modifiers;
        String name;
    ...
    case INCLUDES:
      ...
      extendedSpecList = RVMExtendedSpec();
      break;
    default:
      jj_la1[7] = jj_gen;
      ;
    ...
    jj_consume_token(RBRACE);
         {if (true) return new RVMonitorSpecExt(packageName, line, column, isPublic, modifiers, name, parameters, inMethod, extendedSpecList, declarations, events, props);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      case UNSYNC:
        jj_consume_token(UNSYNC);
                           modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.UNSYNC, token);
        break;
      case DECENT:
        jj_consume_token(DECENT);
                          modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.DECENTRL, token);
        break;
      case PERTHREAD:
        jj_consume_token(PERTHREAD);
                      modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.PERTHREAD, token);
        break;
      case SUFFIX:
        jj_consume_token(SUFFIX);
                   modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.SUFFIX, token);
        break;
      case FULLBIND:
        jj_consume_token(FULLBIND);
                         modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.FULLBINDING, token);
        break;
      case AVOID:
        jj_consume_token(AVOID);
                  modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.AVOID, token);
        break;
      case ENFORCE:
        jj_consume_token(ENFORCE);
                    modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.ENFORCE, token);
        break;
      case CONNECTED:
        jj_consume_token(CONNECTED);
                      modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.CONNECTED, token);
        break;
      default:
        jj_la1[11] = jj_gen;
        jj_consume_token(-1);
...
//**************** soha adding here*************/
//List<RVMExtendedSpec> RVMExtendedSpec():
  final public List<ExtendedSpec> RVMExtendedSpec() throws ParseException {
...
//************ soha ends addition here*************/
  final public List<RVMParameter> RVMParameters() throws ParseException {
        List<RVMParameter> parameters = new ArrayList<RVMParameter>();
        RVMParameter p = null;
    jj_consume_token(LPAREN);
    switch (jj_nt.kind) {
    case GET:
  ...
  final public List<RVMParameter> AdviceParameters() throws ParseException {
        List<RVMParameter> parameters = new ArrayList<RVMParameter>();
        RVMParameter p = null;
    jj_consume_token(LPAREN);
    switch (jj_nt.kind) {
  ...
  final public RVMParameter RVMParameter() throws ParseException {
        TypePattern type;
        String name;
        int line;
        int column;
    ...
    default:
      ...
      throw new ParseException();
                                                                                                                                  ...
                                                                                                                                  name = token.image;
          {if (true) return new RVMParameter(line, column, type, name);}
    throw new Error("Missing return statement in function");
  }

  final public RVMParameter AdviceParameter() throws ParseException {
        TypePattern type;
        String name;
        int line;
        int column;
  ...
  final public EventDefinitionExt Event() throws ParseException {
    ...
    default:
      ...
      throw new ParseException();
          ...
          {if (true) return new EventDefinitionExt(line, column, name, parameters, block, startEvent, blockingEvent);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Modifier Modifiers() throws ParseException {
   ...
   AnnotationExpr ann;
    ...
    while (true) {
      ...
      case PUBLIC:
        jj_consume_token(PUBLIC);
              modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.PUBLIC, token);
        break;
      case STATIC:
        jj_consume_token(STATIC);
              modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.STATIC, token);
        break;
      case PROTECTED:
        jj_consume_token(PROTECTED);
                 modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.PROTECTED, token);
        break;
      case PRIVATE:
        jj_consume_token(PRIVATE);
               modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.PRIVATE, token);
        break;
      case FINAL:
        jj_consume_token(FINAL);
             modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.FINAL, token);
        break;
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
                modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.ABSTRACT, token);
        break;
      case SYNCHRONIZED:
        jj_consume_token(SYNCHRONIZED);
                    modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.SYNCHRONIZED, token);
        break;
      case NATIVE:
        jj_consume_token(NATIVE);
              modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.NATIVE, token);
        break;
      case TRANSIENT:
        jj_consume_token(TRANSIENT);
                 modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.TRANSIENT, token);
        break;
      case VOLATILE:
        jj_consume_token(VOLATILE);
                modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.VOLATILE, token);
        break;
      case STRICTFP:
        jj_consume_token(STRICTFP);
                modifiers = com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.addModifier(modifiers, com.runtimeverification.rvmonitor.java.rvj.parser.ast.body.ModifierSet.STRICTFP, token);
        break;
      case AT:
        ann = Annotation();
                        annotations = add(annotations, ann);
...
/* Annotation Types. */
  ...
  public RVMonitorParserTokenManager token_source;
  ...
  public RVMonitorParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public RVMonitorParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new RVMonitorParserTokenManager(jj_input_stream);
    token = new Token();
  ...
  /** Constructor. */
  public RVMonitorParser(java.io.Reader stream) {
  ...
  public RVMonitorParser(RVMonitorParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(RVMonitorParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;
