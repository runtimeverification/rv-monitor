...
public class BasicRefMapOfSet<TSet extends IIndexingTree> extends AbstractMapOfSet<CachedWeakReference, TSet> implements IWeakRefTableOperation<CachedWeakReference> {
