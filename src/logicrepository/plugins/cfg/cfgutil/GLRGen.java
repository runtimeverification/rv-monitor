...
public class GLRGen {
   ...
   static String gen(LR lr, String name) {
      return "package rvmonitor.LogicPluginShells.JavaCFG.CFGUtil;\nimport java.util.*;"
         + "class "+name+" {\n" + state(lr) +"\n"
         + name +"() {"+init(lr)+"\n}\n"
