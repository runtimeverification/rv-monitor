...
public class Main {
	...
	public static void print_help() {
		System.out.println("Usage: java [-cp rv_monitor_classpath] rvmonitor.Main [-options] files");
		System.out.println("");
		...
		System.out.println("\t\t\t\t   in rvmonitor/config/remote_server_addr.properties)");
