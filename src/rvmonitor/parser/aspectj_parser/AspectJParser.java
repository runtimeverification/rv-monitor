...
package rvmonitor.parser.aspectj_parser;
import java.io.*;
import java.util.*;
...
import rvmonitor.parser.astex.aspectj.*;
  ...
  AnnotationExpr ann;
    ...
    while (true) {
      ...
      case PUBLIC:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.PUBLIC, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
      ...
      case STATIC:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.STATIC, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
      ...
      case PROTECTED:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.PROTECTED, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
      ...
      case PRIVATE:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.PRIVATE, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
      ...
      case FINAL:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.FINAL, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
      ...
      case ABSTRACT:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.ABSTRACT, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
      ...
      case SYNCHRONIZED:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.SYNCHRONIZED, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
      ...
      case NATIVE:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.NATIVE, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
      ...
      case TRANSIENT:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.TRANSIENT, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
      ...
      case VOLATILE:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.VOLATILE, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
      ...
      case STRICTFP:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.STRICTFP, new rvmonitor.parser.main_parser.Token(token));
        }
        catch (rvmonitor.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token, e.getMessage());}
