...
package rvmonitor.parser.main_parser;
    ...
    while (true) {
      ...
      case UNSYNC:
        jj_consume_token(UNSYNC);
                           modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.UNSYNC, token);
        break;
      case DECENT:
        jj_consume_token(DECENT);
                          modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.DECENTRL, token);
        break;
      case PERTHREAD:
        jj_consume_token(PERTHREAD);
                      modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.PERTHREAD, token);
        break;
      case SUFFIX:
        jj_consume_token(SUFFIX);
                   modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.SUFFIX, token);
        break;
      case FULLBIND:
        jj_consume_token(FULLBIND);
                         modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.FULLBINDING, token);
        break;
      case AVOID:
        jj_consume_token(AVOID);
                  modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.AVOID, token);
        break;
      case ENFORCE:
        jj_consume_token(ENFORCE);
                    modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.ENFORCE, token);
        break;
      case CONNECTED:
        jj_consume_token(CONNECTED);
                      modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.CONNECTED, token);
        break;
      default:
        jj_la1[11] = jj_gen;
        jj_consume_token(-1);
  ...
  final public Modifier Modifiers() throws ParseException {
   ...
   AnnotationExpr ann;
    ...
    while (true) {
      ...
      case PUBLIC:
        jj_consume_token(PUBLIC);
              modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.PUBLIC, token);
        break;
      case STATIC:
        jj_consume_token(STATIC);
              modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.STATIC, token);
        break;
      case PROTECTED:
        jj_consume_token(PROTECTED);
                 modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.PROTECTED, token);
        break;
      case PRIVATE:
        jj_consume_token(PRIVATE);
               modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.PRIVATE, token);
        break;
      case FINAL:
        jj_consume_token(FINAL);
             modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.FINAL, token);
        break;
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
                modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.ABSTRACT, token);
        break;
      case SYNCHRONIZED:
        jj_consume_token(SYNCHRONIZED);
                    modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.SYNCHRONIZED, token);
        break;
      case NATIVE:
        jj_consume_token(NATIVE);
              modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.NATIVE, token);
        break;
      case TRANSIENT:
        jj_consume_token(TRANSIENT);
                 modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.TRANSIENT, token);
        break;
      case VOLATILE:
        jj_consume_token(VOLATILE);
                modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.VOLATILE, token);
        break;
      case STRICTFP:
        jj_consume_token(STRICTFP);
                modifiers = rvmonitor.parser.ast.body.ModifierSet.addModifier(modifiers, rvmonitor.parser.ast.body.ModifierSet.STRICTFP, token);
        break;
      case AT:
        ann = Annotation();
                        annotations = add(annotations, ann);
