...
public class LogicRepositoryData {
	...
	public ByteArrayOutputStream transXMLToOutputStream(LogicRepositoryType xmlData) throws RVMException {
		...
		try {
			logicData = JAXBContext.newInstance("rvmonitor.parser.logicrepositorysyntax");
			Marshaller marshaller = logicData.createMarshaller();
			rvmonitor.parser.logicrepositorysyntax.ObjectFactory factory = new rvmonitor.parser.logicrepositorysyntax.ObjectFactory();
	...
	public LogicRepositoryType transInputStreamToXML(InputStream inputStream) throws RVMException {
		...
		try {
			logicRequest = JAXBContext.newInstance("rvmonitor.parser.logicrepositorysyntax");
