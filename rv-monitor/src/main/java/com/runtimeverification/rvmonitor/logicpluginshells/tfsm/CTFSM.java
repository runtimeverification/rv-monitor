...
import com.runtimeverification.rvmonitor.logicpluginshells.tfsm.parser.*;
import com.runtimeverification.rvmonitor.logicpluginshells.tfsm.ast.*;
...
public class CTFSM extends LogicPluginShell {
  ...
  private Properties getNonParametricMonitorCode(LogicRepositoryType logicOutput) throws RVMException {
    ...
    if(cats.contains("timeout")){
      ...
      +  cSpec.getHandlers().get("timeout").replaceAll("__RESET", resetName + "()\n")
      + "\n}\n\n"
