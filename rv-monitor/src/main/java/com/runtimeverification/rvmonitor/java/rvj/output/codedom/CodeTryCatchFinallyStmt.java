...
public class CodeTryCatchFinallyStmt extends CodeStmt {
	...
	public CodeTryCatchFinallyStmt(CodeStmtCollection tryblock, CodeStmtCollection finallyblock, CatchBlock ... catchblocks) {
		this(tryblock, finallyblock, Arrays.asList(catchblocks));
	}

	public CodeTryCatchFinallyStmt(CodeStmtCollection tryblock, CodeStmtCollection finallyblock, List<CatchBlock> catchblocks) {
