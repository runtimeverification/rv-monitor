 ...
 * Ideally, all RV-Monitor API should go through this class, rather than hard-coded.
 * At the time of writing this comment, however, this ideal has not been achieved.
 *
