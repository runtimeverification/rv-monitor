...
public class MonitorInfo {
	...
	public String newInfo(RVMVariable monitorVar, RVMParameters vars) {
		...
		ret += monitorVar + "." + monitorInfo + " = " + "new com.runtimeverification.rvmonitor.java.rt.RVMMonitorInfo();\n";
	...
	public String copy(RVMVariable monitorVar) {
		...
		ret += monitorVar + "." + monitorInfo + " = " + "(com.runtimeverification.rvmonitor.java.rt.RVMMonitorInfo)" + "this." + monitorInfo + ".clone();\n";
	...
	public String copy(String targetVar, String origVar) {
		...
		ret += targetVar + "." + monitorInfo + " = " + "(com.runtimeverification.rvmonitor.java.rt.RVMMonitorInfo)" + origVar + "." + monitorInfo + ".clone();\n";
	...
	public String monitorDecl() {
		...
		ret += "com.runtimeverification.rvmonitor.java.rt.RVMMonitorInfo " + monitorInfo + ";\n";
