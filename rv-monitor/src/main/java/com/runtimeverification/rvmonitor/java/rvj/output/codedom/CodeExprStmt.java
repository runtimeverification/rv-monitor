...
/**
 * This class represents a statement that holds an expression.
 * For example, an expression that represents a method invocation
 * can be encapsulated into an instance of this class:
 * <code>
