 ...
 * 1. a marker: having a specialized type for the generated Monitor enables the code
 * generator to make distinction between a Monitor instance and a DisableHolder instance,
 * using RTTI; i.e., the 'instanceof' operator.
 * 2. associated data: a subclass of this class may define additional information, which
 * is similar to a tag, in the sense that that is associated with
 * the core, the CodeType object in this context. That information is used solely during code
 * generation; i.e., the resulting code is not affected.
 * For example, a Tuple class, a subclass of this class, represents Tuple2 or Tuple3, and it keeps
 * the elements of the tuple.
 * 
 * As its package name implies, this class is used solely during code generation. The runtime
 * library and the generated code never refers to any of it or its subclass.
 *
...
public class CodeRVType extends CodeType {
	...
	public static CodeRVType.PartitionedMonitorSet forPartitionedMonitorSet(String typename, Map<RVMParameter, List<IndexingTreeInterface>> ctorargsmap) {
		return new PartitionedMonitorSet(new CodeType(typename), ctorargsmap);
	}
	
	public static CodeRVType.Tuple forTuple(CodeType tupletype, List<CodeRVType> elems) {
	...
	/**
	 * This class corresponds to an interface generated when a leaf
	 * can hold either a Monitor instance or a DisableHolder instance.
	 * 
	 * @author Choonghwan Lee <clee83@illinois.edu>
	 */
	...
	/**
	 * This class corresponds the DisableHolder class in the runtime
	 * library.
	 * 
	 * @author Choonghwan Lee <clee83@illinois.edu>
	...
	/**
	 * This class represents a generated monitor class.
	 * The generated monitor code implements the IMonitor interface
	...
	/**
	 * This class represents a generated monitor set class.
	 *e
	 * @author Choonghwan Lee <clee83@illinois.edu>
	 */
	...
	/**
	 * This class represents a basic set implementation.
	 * The generated set will be a subclass of the AbstractMonitorSet class.
	 *
	 * @author Choonghwan Lee <clee83@illinois.edu>
	...
	/**
	 * This class represents a partition set implementation.
	 * The generated set will be a subclass of the AbstractPartitionedMonitorSet class.
	 *
	 * @author Choonghwan Lee <clee83@illinois.edu>
	...
	public static class PartitionedMonitorSet extends MonitorSet {
		...
		PartitionedMonitorSet(CodeType t, Map<RVMParameter, List<IndexingTreeInterface>> ctorargsmap) {
			super(t);

			this.ctorargsmap = ctorargsmap;
		}
		
		public List<IndexingTreeInterface> getConstructorArguments(RVMParameter prm) {
	 ...
	 * An instance of this class corresponds to Tuple2 or Tuple3 in the runtime library.
	 * 
	 * @author Choonghwan Lee <clee83@illinois.edu>
