...
public class CodeMemberMethod extends CodeMember implements ICodeGenerator {
	...
	public CodeMemberMethod(String name, boolean publik, boolean statik, boolean finale, CodeType type, boolean overriding, CodeStmt body) {
		this(name, publik, statik, finale, type, overriding, new CodeStmtCollection(body));
	}

	public CodeMemberMethod(String name, boolean publik, boolean statik, boolean finale, CodeType type, boolean overriding, CodeStmt body, CodeVariable ... params) {
		this(name, publik, statik, finale, type, overriding, new CodeStmtCollection(body), params);
	}
	
	public CodeMemberMethod(String name, boolean publik, boolean statik, boolean finale, CodeType type, boolean overriding, CodeStmtCollection body, CodeVariable ... params) {
