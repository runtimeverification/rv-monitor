...
public class JavaControlApiIT {
    private TestHelper helper;
    private String rvmFile;
    private String rvmDirectory;

    public JavaControlApiIT(String specPath) {
        rvmFile = specPath;
    ...
    public void testTest() throws Exception {
        ...
        helper.testCommand(null, projectRoot + File.separator + "bin" + File.separator + "rv-monitor", "--controlAPI", "rvm" + File.separator + rvmName + ".rvm");
    ...
    public static Collection<Object[]> data() {
        ...
        for (File rvmFile : FileUtils.listFiles(new File("../examples/control_api/"), new String[]{"rvm"}, true)) {
